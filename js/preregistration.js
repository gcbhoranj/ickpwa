    ...
    root.innerHTML =
      '<div class="wizard-card">' +
        ...
        (preRegistrations.length === 0
          ...
          : '<div style="overflow-x:auto"><table><thead><tr><th>College</th><th>District</th><th>Members</th><th>Travel Mode</th><th>Arrival Date</th><th>Accommodation</th><th>WhatsApp Joined</th><th>Submitted</th></tr></thead>' +
            '<tbody id="prereg-tbody">' +
              preRegistrations.map(function (r) {
                return '<tr class="prereg-row" data-preregid="' + r.preRegId + '" style="cursor:pointer">' +
                  ...
                  '<td>' + r.travelMode + '</td><td>' + (r.dateOfArrival || '—') + '</td><td>' + (r.accommodationRequired || '—') + '</td>' +
                  '<td>' + (r.joinedWhatsAppGroup || '—') + '</td>' +
