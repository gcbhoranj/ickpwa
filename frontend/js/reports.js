...
function _renderReportTab(tab, bundle) {
  if (tab === 'financial') {
    return '<table><thead><tr><th>Reg No</th><th>College</th><th>Dari</th><th>Security</th><th>Food Revenue</th><th>Food Refund</th><th>Security Refunded</th><th>Final Balance</th></tr></thead><tbody>' +
  ...
  if (tab === 'food') {
    return '<table><thead><tr><th>Reg No</th><th>College</th><th>Packages</th><th>Revenue</th><th>Eligible</th><th>Served</th><th>Remaining</th><th>Refunded</th></tr></thead><tbody>' +
  ...
  if (tab === 'accommodation') {
    return '<h3>Rooms</h3><table><thead><tr><th>Room</th><th>Type</th><th>Capacity</th><th>Allocated</th><th>Remaining</th><th>Status</th></tr></thead><tbody>' +
      ...
      '<h3 style="margin-top:12px">Teams</h3><table><thead><tr><th>Reg No</th><th>College</th><th>Members Allocated</th><th>Needed</th><th>Incharges Allocated</th><th>NOC</th></tr></thead><tbody>' +
  ...
  if (tab === 'departure') {
    return '<table><thead><tr><th>Reg No</th><th>College</th><th>Status</th><th>Locked By</th></tr></thead><tbody>' +
